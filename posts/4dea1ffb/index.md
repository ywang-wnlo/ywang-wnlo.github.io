...
其中 `env` 下的变量需要自行配置，`PUBLIC_REPO` 是 GitHub Pages 仓库的名称，`PUBLIC_REPO_PAT` 是 GitHub Pages 仓库的 `Personal access tokens`，需要自行创建，具体步骤可以参考 [【GitHub】Managing your personal access tokens](https://docs.github.com/zh/authentication/keeping-your-account-and-data-secure/managing-your-personal-access-tokens)
...
-  [【GitHub】Managing your personal access tokens](https://docs.github.com/zh/authentication/keeping-your-account-and-data-secure/managing-your-personal-access-tokens)
